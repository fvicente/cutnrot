...
# The manifest will be inserted as resource into cutnrot.exe.  This
# gives the controls the Windows XP appearance (if run on XP ;-)
#
# Another option would be to store if in a file named
# cutnrot.exe.manifest, and probably copy it with the data_files
# option.
#
manifest_template = '''
...
cutnrot = dict(
    script = "cutnrot.py",
    other_resources = [(RT_MANIFEST, 1, manifest_template % dict(prog="cutnrot"))],
    dest_base = r"prog\cutnrot")
...
class InnoScript:
    ...
    def create(self, pathname="dist\\cutnrot.iss"):
